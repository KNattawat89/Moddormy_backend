...
func PostFilteredNoFav(c *fiber.Ctx) error {
		...
		if len(body.Facilities) > 0 {
			...
			if len(body.Facilities) == 1 {
				if strings.EqualFold(*body.Facilities[0], "parking") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? ", ffilterAir).Preload("Reviews").Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("parking = ?", filterParking).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("wifi = ?", filterWifi).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ?", filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("security_guard = ?", filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("pet = ?", filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("parking = ? AND wifi = ?", filterParking, filterWifi).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND smoke_free =?", filterParking, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND security_guard =?", filterParking, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND pet =?", filterParking, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking = ? ", filterParking).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("wifi = ? AND smoke_free =?", filterWifi, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("wifi = ? AND security_guard = ?", filterWifi, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("wifi = ? AND pet = ?", filterWifi, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("wifi = ? ", filterWifi).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ? AND security_guard = ?", filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ? AND pet = ?", filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free = ?", filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("security_guard = ? AND pet = ?", filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Where("security_guard = ?", filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Where("pet = ?", filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =?", filterParking, filterWifi, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =?", filterParking, filterWifi, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND pet =?", filterParking, filterWifi, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? ", filterParking, filterWifi).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =?", filterParking, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND pet =?", filterParking, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? ", filterParking, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND security_guard =? AND pet=?", filterParking, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND security_guard =? ", filterParking, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND pet =? ", filterParking, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? ", filterWifi, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND pet =? ", filterWifi, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=?", filterWifi, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND security_guard=? AND pet =? ", filterWifi, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND security_guard=?", filterWifi, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND pet=?", filterWifi, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("smoke_free =? AND security_guard=? AND pet =? ", filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND security_guard=?", filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND pet=?", filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("security_guard =? AND pet=?", filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") && strings.EqualFold(*body.Facilities[4], "pet friendly") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=?", filterParking, filterWifi, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =?", filterParking, filterWifi, filterSmokeFree).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? AND pet=?", filterParking, filterWifi, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? ", filterParking, filterWifi, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND pet =? ", filterParking, filterWifi, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? AND pet=?", filterParking, filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? ", filterParking, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND pet =? ", filterParking, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND security_guard=? AND pet =? ", filterParking, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? AND pet=?", filterWifi, filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? ", filterWifi, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND pet =? ", filterWifi, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND security_guard=? AND pet =? ", filterWifi, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND security_guard=? AND pet =? ", filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") && strings.EqualFold(*body.Facilities[4], "pet friendly") && strings.EqualFold(*body.Facilities[5], "air-conditioner") {
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=?", filterParking, filterWifi, filterSmokeFree, filterGuard).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? AND pet=?", filterParking, filterWifi, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? AND pet=?", filterParking, filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? AND pet=?", filterWifi, filterSmokeFree, filterGuard, filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
						return &response.GenericError{
				...
				//1
				if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("parking = ?", filterParking).Where("wifi = ?", filterWifi).Where("smoke_free = ?", filterSmokeFree).Where("security_guard = ?", filterGuard).Where("pet = ?", filterPet).Where("distant <= ?", *body.Distant).Find(&dorms); result.Error != nil {
					return &response.GenericError{
		...
		if len(body.Facilities) > 0 {
			...
			if len(body.Facilities) == 1 {
				if strings.EqualFold(*body.Facilities[0], "parking") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? ", ffilterAir).Preload("Reviews").Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm that have air-conditioner room",
							Err:     result.Error,
						}
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("parking = ?", filterParking).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking and air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("wifi = ?", filterWifi).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi and air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ?", filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free and air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("security_guard = ?", filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with security guard and air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("pet = ?", filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with pet friendly and air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with air-conditioner and fan",
							Err:     result.Error,
						}
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("parking = ? AND wifi = ?", filterParking, filterWifi).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, airc",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND smoke_free =?", filterParking, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND security_guard =?", filterParking, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, security guard, airc",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking = ? AND pet =?", filterParking, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, pet friendly, airc",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking = ? ", filterParking).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("wifi = ? AND smoke_free =?", filterWifi, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, air",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("wifi = ? AND security_guard = ?", filterWifi, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, security guard, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("wifi = ? AND pet = ?", filterWifi, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("wifi = ? ", filterWifi).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ? AND security_guard = ?", filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, security guard, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("smoke_free = ? AND pet = ?", filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, pet, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free = ?", filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ?", ffilterAir).Preload("Reviews").Where("security_guard = ? AND pet = ?", filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with security guard, pet, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Where("security_guard = ?", filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with security guard, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan = ?", ffilterAir, filterFan).Preload("Reviews").Where("pet = ?", filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc =?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =?", filterParking, filterWifi, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =?", filterParking, filterWifi, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, security guard, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND pet =?", filterParking, filterWifi, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? ", filterParking, filterWifi).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =?", filterParking, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, security guard, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND pet =?", filterParking, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? ", filterParking, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND security_guard =? AND pet=?", filterParking, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, security guard, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND security_guard =? ", filterParking, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, security guard, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND pet =? ", filterParking, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking,  pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? ", filterWifi, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, security guard, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND pet =? ", filterWifi, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=?", filterWifi, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND security_guard=? AND pet =? ", filterWifi, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, security guard, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND security_guard=?", filterWifi, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, security guard, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND pet=?", filterWifi, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("smoke_free =? AND security_guard=? AND pet =? ", filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, security guard, pet friendly, air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND security_guard=?", filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, security guard, air-conditione, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND pet=?", filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free, pet friendly, air-conditione, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("security_guard =? AND pet=?", filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with security guard, pet friendly, air-conditione, fan",
							Err:     result.Error,
						}
				...
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") && strings.EqualFold(*body.Facilities[4], "pet friendly") {
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=?", filterParking, filterWifi, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, security guard,  air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, pet friendly,  air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =?", filterParking, filterWifi, filterSmokeFree).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? AND pet=?", filterParking, filterWifi, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, security guard, pet friendly,  air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? ", filterParking, filterWifi, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, security guard, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND pet =? ", filterParking, filterWifi, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? AND pet=?", filterParking, filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, security guard, pet friendly,  air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? ", filterParking, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, security guard, air-conditioner,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND pet =? ", filterParking, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, pet friendly, air-conditioner,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND security_guard=? AND pet =? ", filterParking, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, security guard, pet friendly, air-conditioner,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? AND pet=?", filterWifi, filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, security guard, pet friendly,  air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? ", filterWifi, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, security guard, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND pet =? ", filterWifi, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND security_guard=? AND pet =? ", filterWifi, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi,security guard, pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("smoke_free =? AND security_guard=? AND pet =? ", filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with smoke-free,security guard, pet friendly, air-conditioner, fan",
							Err:     result.Error,
						}
				...
				//7
				if strings.EqualFold(*body.Facilities[0], "parking") && strings.EqualFold(*body.Facilities[1], "wifi") && strings.EqualFold(*body.Facilities[2], "smoke-free") && strings.EqualFold(*body.Facilities[3], "security guard") && strings.EqualFold(*body.Facilities[4], "pet friendly") && strings.EqualFold(*body.Facilities[5], "air-conditioner") {
					if result := mysql.Gorm.Preload("Rooms", "airc=?", ffilterAir).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, security guard, pet friendly,air-conditioner",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND security_guard=?", filterParking, filterWifi, filterSmokeFree, filterGuard).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, security guard, air-conditioner ,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND smoke_free =? AND pet=?", filterParking, filterWifi, filterSmokeFree, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, smoke-free, pet friendly, air-conditioner ,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND wifi=? AND security_guard =? AND pet=?", filterParking, filterWifi, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, wifi, security guard, pet friendly, air-conditioner ,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("parking =? AND smoke_free=? AND security_guard =? AND pet=?", filterParking, filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with parking, smoke-free, security guard, pet friendly, air-conditioner ,fan",
							Err:     result.Error,
						}
					...
					if result := mysql.Gorm.Preload("Rooms", "airc=? OR fan=?", ffilterAir, filterFan).Preload("Reviews").Where("wifi =? AND smoke_free=? AND security_guard =? AND pet=?", filterWifi, filterSmokeFree, filterGuard, filterPet).Find(&dorms); result.Error != nil {
						return &response.GenericError{
							Message: "Not find dorm with wifi, smoke-free, security guard, pet friendly, air-conditioner ,fan",
							Err:     result.Error,
						}
				...
				//1
				if result := mysql.Gorm.Preload("Rooms", "airc = ? OR fan =?", ffilterAir, filterFan).Preload("Reviews").Where("parking = ?", filterParking).Where("wifi = ?", filterWifi).Where("smoke_free = ?", filterSmokeFree).Where("security_guard = ?", filterGuard).Where("pet = ?", filterPet).Find(&dorms); result.Error != nil {
					return &response.GenericError{
						Message: "Dorm not found",
						Err:     result.Error,
					}
	...
	var finalData []payload.DormSearch
